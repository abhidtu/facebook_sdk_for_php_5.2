 ...
 * @package Facebook
 */
class Facebook_Entities_AccessToken
{
  ...
  public function isValid($appId = null, $appSecret = null, $machineId = null)
  {
    ...
    return self::validateAccessToken($accessTokenInfo, $appId, $machineId);
  }
  ...
  public static function getAccessTokenFromCode($code, $appId = null, $appSecret = null, $machineId = null)
  {
    ...
    return self::requestAccessToken($params, $appId, $appSecret);
  }
  ...
  public static function getCodeFromAccessToken($accessToken, $appId = null, $appSecret = null)
  {
    ...
    return self::requestCode($params, $appId, $appSecret);
  }
  ...
  {
    $response = self::request('/oauth/access_token', $params, $appId, $appSecret);
  ...
  {
    $response = self::request('/oauth/client_code', $params, $appId, $appSecret);
    $data = $response->getResponse();
