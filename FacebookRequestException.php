 ...
 */
class Facebook_FacebookRequestException extends Facebook_FacebookSDKException
{
  ...
  public static function create($raw, $data, $statusCode)
  {
    ...
    if (isset($data['error']['error_subcode'])) {
      switch ($data['error']['error_subcode']) {
        ...
        case 464:
        case 467:
          return new Facebook_FacebookAuthorizationException($raw, $data, $statusCode);
          break;
      }
    }
    ...
    switch ($code) {
      ...
      case 1:
      case 2:
        return new Facebook_FacebookServerException($raw, $data, $statusCode);
        break;
      ...
      case 17:
      case 341:
        return new Facebook_FacebookThrottleException($raw, $data, $statusCode);
        break;

      // Duplicate Post
      case 506:
        return new Facebook_FacebookClientException($raw, $data, $statusCode);
        break;
    }

    // Missing Permissions
    if ($code == 10 || ($code >= 200 && $code <= 299)) {
      return new Facebook_FacebookPermissionException($raw, $data, $statusCode);
    }
    ...
    // All others
    return new Facebook_FacebookOtherException($raw, $data, $statusCode);
  }
