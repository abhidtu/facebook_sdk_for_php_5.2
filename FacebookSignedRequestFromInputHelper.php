 ...
 * @package Facebook
 */
abstract class Facebook_FacebookSignedRequestFromInputHelper
{
  ...
  public function instantiateSignedRequest($rawSignedRequest = null)
  {
    ...
    $this->signedRequest = new Facebook_Entities_SignedRequest($rawSignedRequest, $this->state, $this->appSecret);
  }
  ...
  public function getSession()
  {
    if ($this->signedRequest && $this->signedRequest->hasOAuthData()) {
      return Facebook_FacebookSession::newSessionFromSignedRequest($this->signedRequest);
    }
    return null;
  }
