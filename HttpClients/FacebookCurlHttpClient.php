 ...
 * @package Facebook
 */
class Facebook_HttpClients_FacebookCurlHttpClient implements Facebook_HttpClients_FacebookHttpable
{
  ...
  {
    //self::$facebookCurl = $facebookCurl ?: new Facebook_HttpClients_FacebookCurl();
      ...
      {
        self::$facebookCurl = new Facebook_HttpClients_FacebookCurl();
      }
