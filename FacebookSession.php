 ...
 */
class Facebook_FacebookSession
{
  ...
  {
    $this->accessToken = $accessToken instanceof Facebook_Entities_AccessToken ? $accessToken : new Facebook_Entities_AccessToken($accessToken);
  ...
  public function getLongLivedSession($appId = null, $appSecret = null)
  {
    ...
    return new self($longLivedAccessToken);
  }
  ...
  {
    return Facebook_Entities_AccessToken::getCodeFromAccessToken($this->accessToken, $appId, $appSecret);
  }
  ...
  public function validate($appId = null, $appSecret = null, $machineId = null)
  {
    ...
    throw new Facebook_FacebookSDKException(
  ...
  public static function validateSessionInfo(GraphSessionInfo $tokenInfo,
                                           ...
                                           $machineId = null)
  {
    if (Facebook_Entities_AccessToken::validateAccessToken($tokenInfo, $appId, $machineId)) {
      return true;
    }
  ...
  public static function newSessionFromSignedRequest(SignedRequest $signedRequest)
  {
    ...
    $accessToken = new Facebook_Entities_AccessToken($accessToken, $expiresAt);
    return new self($accessToken, $signedRequest);
  }
  ...
  protected static function newSessionAfterValidation(SignedRequest $signedRequest)
  {
    ...
    $accessToken = Facebook_Entities_AccessToken::getAccessTokenFromCode($code);
    return new self($accessToken, $signedRequest);
  }
  ...
  {
    $targetAppId = self::_getTargetAppId($appId);
    $targetAppSecret = self::_getTargetAppSecret($appSecret);
    return new Facebook_FacebookSession(
  ...
  {
    self::$useAppSecretProof = ($on ? true : false);
  }
